...
const PokedexPresentationContainer = ({ pokemon }) => {
  ...
  return (
    <div className="pokedex-presentation-container">
      ...
      <Typography variant="h4" className="pokedex-presentation-name">
        {pokemon.name}
      </Typography>
      <Typography variant="h5">{"ID: " + pokemon.id}</Typography>

      <div className="pokedex-presentation-type">
        <Typography className="pokedex-presentation-type__title" variant="h5">
      ...
      <div className="pokedex-presentation-data">
        ...
        <div className="pokedex-presentation-data__height">
          <Typography className="pokedex-presentation-data_height-title">
            Height
          </Typography>
          <Typography> {pokemon.height / 10 + " meters"}</Typography>
        </div>
        <div className="pokedex-presentation-data__weight">
          <Typography className="pokedex-presentation-data_height-title">
            Weight
          </Typography>
          <Typography>{pokemon.weight / 10 + " kilograms"}</Typography>
        </div>
      </div>
    </div>
  );
